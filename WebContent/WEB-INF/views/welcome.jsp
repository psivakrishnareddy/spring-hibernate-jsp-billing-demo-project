...
<hr>
<div class="container">
<h1 class="text-white">Welcome to Spring shoping..Demo</h1>
<h3>Click to continue</h3>
<a class="btn btn-success" href="<c:url value='/shop/shop-110' />">Shopping.......Go Go Go......</a>
</div>
</body>
</html>